...
export type ToastComponent = FC<PropsWithChildren<{ onDismiss: () => void }>>;

export const InfoToast: ToastComponent = ({ children, onDismiss }) => {
    return (
        <Toast>
...
export const SuccessToast: ToastComponent = ({ children }) => {
    return (
        <Toast>
...
export const FailureToast: ToastComponent = ({ children }) => {
    return (
        <Toast>
...
export const WarningToast: ToastComponent = ({ children }) => {
    return (
        <Toast>
